...
export default function StackedCard({
	...
	return (
		<motion.div
			id={`slide-${pos}`}
			className="m-2 border-2 border-info border-offset-2 odd:rotate-3 md:odd:rotate-1 even:-rotate-3 md:even:-rotate-1 rounded-2xl bg-primary/70 backdrop-blur-sm p-4 font-inter md:max-w-4xl cursor-grab active:cursor-grabbing touch-manipulation"
			drag="x"
			style={{
				gridRow: 1,
				gridColumn: 1,
